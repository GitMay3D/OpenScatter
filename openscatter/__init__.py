...
bl_info = {
    "name" : "OpenScatter",
    "author" : "May3D", 
    "description" : "OpenScatter is a free and open-source Blender addon for advanced scattering. It's built from the ground up with artists in mind. It includes various features to simulate the natural patterns of foliage growth, as well as less realistic features for users who want artistic control.",
    "blender" : (4, 2, 0),
    "version" : (1, 0, 0),
    "location" : "",
    "warning" : "",
...
class SNA_PT_OPENSCATTER_6192D(bpy.types.Panel):
    bl_label = 'OpenScatter'
    bl_idname = 'SNA_PT_OPENSCATTER_6192D'
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OPENSCATTER_6192D)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OPENSCATTER_6192D)
