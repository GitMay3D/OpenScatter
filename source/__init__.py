...
bl_info = {
    "name" : "OpenScatter",
    "author" : "May3D", 
    "description" : "OpenScatter is a free and open-source Blender addon for advanced scattering. It's built from the ground up with artists in mind. ",
    "blender" : (4, 3, 0),
    "version" : (1, 0, 0),
    "location" : "",
    "warning" : "",
...
class SNA_PT_OPENSCATTER_A5FAE(bpy.types.Panel):
    bl_label = 'OpenScatter'
    bl_idname = 'SNA_PT_OPENSCATTER_A5FAE'
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OPENSCATTER_A5FAE)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OPENSCATTER_A5FAE)
