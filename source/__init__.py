...
class SNA_PT_OPENSCATTER_BC3D2(bpy.types.Panel):
    bl_label = 'OpenScatter'
    bl_idname = 'SNA_PT_OPENSCATTER_BC3D2'
...
def sna_func_texturemasks2_E0304(layout_function, ):
    ...
    row_93C28.prop(bpy.context.scene, 'sna_display_image', text='', icon_value=(31 if bpy.context.scene.sna_display_image else 30), emboss=False)
    ...
    if bpy.context.scene.sna_display_image:
        ...
        row_88AA1.label(text='', icon_value=1)
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OPENSCATTER_BC3D2)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OPENSCATTER_BC3D2)
