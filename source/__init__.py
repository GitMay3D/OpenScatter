...
bl_info = {
    ...
    "location" : "",
    "warning" : "",
    "doc_url": "https://github.com/GitMay3D/OpenScatter/blob/main/docs/docs.md", 
...
class SNA_PT_OPENSCATTER_7E9AB(bpy.types.Panel):
    bl_label = 'OpenScatter'
    bl_idname = 'SNA_PT_OPENSCATTER_7E9AB'
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OPENSCATTER_7E9AB)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OPENSCATTER_7E9AB)
