...
class SNA_PT_OPENSCATTER_F8ABE(bpy.types.Panel):
    bl_label = 'OpenScatter'
    bl_idname = 'SNA_PT_OPENSCATTER_F8ABE'
...
def sna_func_culling_CEC85(layout_function, ):
    ...
    if bpy.context.scene.sna_display_culling:
        ...
        if bpy.context.scene.sna_display_vertex_group:
            ...
            op = row_5E09E.operator('sna.enter_weight_paint_mode_db6f9', text='', icon_value=string_to_icon('MOD_VERTEX_WEIGHT'), emboss=True, depress=False)
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OPENSCATTER_F8ABE)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OPENSCATTER_F8ABE)
