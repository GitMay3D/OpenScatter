...
class SNA_PT_OPENSCATTER_DA516(bpy.types.Panel):
    bl_label = 'OpenScatter'
    bl_idname = 'SNA_PT_OPENSCATTER_DA516'
...
class SNA_OT_Add_Scatter_System_Fbb77(bpy.types.Operator):
    ...
    def execute(self, context):
        if 'OBJECT'==bpy.context.mode:
            ...
            bpy.ops.wm.call_panel(name="SNA_PT_cant_create_scatter_systems_in_this_mode_4AA6F", keep_open=False)
        return {"FINISHED"}
...
class SNA_PT_cant_create_scatter_systems_in_this_mode_4AA6F(bpy.types.Panel):
    bl_label = ''
    bl_idname = 'SNA_PT_cant_create_scatter_systems_in_this_mode_4AA6F'
    bl_space_type = 'VIEW_3D'
...
class SNA_PT_QUICK_SCATTER_A1C13(bpy.types.Panel):
    bl_label = 'Quick Scatter'
    bl_idname = 'SNA_PT_QUICK_SCATTER_A1C13'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = ''
    bl_category = 'OpenScatter'
...
class SNA_OT_Scatter_Viewport_Objects_74948(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if objects_selected_1_602b9:
            ...
            bpy.ops.wm.call_panel(name="SNA_PT_WARNING_A94B7", keep_open=False)
        return {"FINISHED"}
...
class SNA_PT_WARNING_A94B7(bpy.types.Panel):
    bl_label = 'Warning!'
    bl_idname = 'SNA_PT_WARNING_A94B7'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'WINDOW'
    bl_context = ''
    bl_order = 0
...
class SNA_OT_Update_8D639(bpy.types.Operator):
    ...
    def execute(self, context):
        version_comparison_0_05fa3 = sna_get_latest_release_func_BC0A1((1, 0, 4))
        if (version_comparison_0_05fa3 == 'higher'):
            bpy.ops.wm.call_panel(name="SNA_PT_USING_NEWER_VERSION_DDCB1", keep_open=False)
        else:
            if (version_comparison_0_05fa3 == 'lower'):
                bpy.ops.wm.call_panel(name="SNA_PT_NEW_VERSION_AVAILABLE_250D7", keep_open=False)
            else:
                bpy.ops.wm.call_panel(name="SNA_PT_NO_NEW_VERSION_AVAILABLE_239EC", keep_open=False)
        return {"FINISHED"}
...
class SNA_PT_NEW_VERSION_AVAILABLE_250D7(bpy.types.Panel):
    bl_label = 'New Version Available'
    bl_idname = 'SNA_PT_NEW_VERSION_AVAILABLE_250D7'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'WINDOW'
    bl_context = ''
    bl_order = 0
...
class SNA_PT_NO_NEW_VERSION_AVAILABLE_239EC(bpy.types.Panel):
    bl_label = 'No New Version Available'
    bl_idname = 'SNA_PT_NO_NEW_VERSION_AVAILABLE_239EC'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'WINDOW'
    bl_context = ''
    bl_order = 0
...
class SNA_PT_USING_NEWER_VERSION_DDCB1(bpy.types.Panel):
    bl_label = 'Using Newer Version'
    bl_idname = 'SNA_PT_USING_NEWER_VERSION_DDCB1'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'WINDOW'
    bl_context = ''
    bl_order = 0
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OPENSCATTER_DA516)
    ...
    bpy.utils.register_class(SNA_PT_cant_create_scatter_systems_in_this_mode_4AA6F)
    ...
    bpy.utils.register_class(SNA_PT_QUICK_SCATTER_A1C13)
    bpy.utils.register_class(SNA_OT_Scatter_Viewport_Objects_74948)
    bpy.utils.register_class(SNA_PT_WARNING_A94B7)
    ...
    bpy.utils.register_class(SNA_PT_NEW_VERSION_AVAILABLE_250D7)
    bpy.utils.register_class(SNA_PT_NO_NEW_VERSION_AVAILABLE_239EC)
    bpy.utils.register_class(SNA_PT_USING_NEWER_VERSION_DDCB1)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OPENSCATTER_DA516)
    ...
    bpy.utils.unregister_class(SNA_PT_cant_create_scatter_systems_in_this_mode_4AA6F)
    ...
    bpy.utils.unregister_class(SNA_PT_QUICK_SCATTER_A1C13)
    bpy.utils.unregister_class(SNA_OT_Scatter_Viewport_Objects_74948)
    bpy.utils.unregister_class(SNA_PT_WARNING_A94B7)
    ...
    bpy.utils.unregister_class(SNA_PT_NEW_VERSION_AVAILABLE_250D7)
    bpy.utils.unregister_class(SNA_PT_NO_NEW_VERSION_AVAILABLE_239EC)
    bpy.utils.unregister_class(SNA_PT_USING_NEWER_VERSION_DDCB1)
